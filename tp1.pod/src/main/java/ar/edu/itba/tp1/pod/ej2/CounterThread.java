...
public class CounterThread extends ThreadSubclass {
	...
	public CounterThread(int times, String name) {
		super(name);
	}

	public CounterThread(int times, String name, String message) {
		super(name, message);
		this.times = times;
	}

	public CounterThread(String name, String message, int sleep_time) {
